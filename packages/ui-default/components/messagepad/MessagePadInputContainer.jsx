...
export default connect(
  ...
  class MessagePadInputContainer extends React.PureComponent {
    static contextTypes = {
    ...
    componentDidUpdate(prevProps) {
      this.focusInput =
        this.props.activeId !== prevProps.activeId || (prevProps.isPosting !== this.props.isPosting && this.props.isPosting === false);
      if (this.focusInput) {
    ...
    submit() {
      this.props.postSend(this.props.activeId, this.props.inputValue);
    }
